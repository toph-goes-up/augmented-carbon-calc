...
var pledgeList = ['more_efficient_vehicle', 'alternativefuel_vehicle', 'electric_vehicle', 'hybrid_vehicle', 'telecommute_to_work', 'ride_my_bike', 'take_public_transportation', 'practice_eco_driving', 'maintain_my_vehicles', 'carpool_to_work', 'reduce_air_travel', 'offset_transportation', 'switch_to_cfl', 'turn_off_lights', 'T12toT8', 'tankless_water_heater', 'thermostat_winter', 'thermostat_summer', 'purchase_high_efficiency_cooling', 'purchase_high_efficiency_heating', 'energy_star_fridge', 'energy_star_printers', 'energy_star_copiers', 'energy_star_desktops', 'rechargeable_batteries', 'power_mgmt_comp', 'purchase_green_electricity', 'install_PV_panels', 'install_solar_heating', 'low_flow_showerheads', 'low_flow_faucets', 'low_flow_toilet', 'line_dry_clothing', 'water_efficient_landscaping', 'plant_trees', 'reduce_comm_waste', 'print_double_sided', 'offset_housing', 'low_carbon_diet', 'go_organic', 'offset_shopping', ];
</script>
...
<div style="position: absolute; top:140px; left: 0; width:749px; ">
<div style="position: relative;">

<div id="sidebar_left" class="sidebar sidebar_left_blue"
 style="position: absolute; left: 0; top:0;  z-index: 300;
 height:400px; width:26px;"></div>
 
 
<div id="sidebar_right" class="sidebar sidebar_right_blue"
 style="position: absolute; right: 0; top:0; z-index: 300;
 height:400px; width:26px;"></div>
 
 <div  class="sidebar bottom_left" 
 style="position: absolute; left: 0; bottom:0;  z-index: 299;
 height:400px; width:26px;"></div>
 
 <div  class="sidebar bottom_right" 
 style="position: absolute; right: 0; bottom:0;  z-index: 299;
 height:400px; width:26px;"></div>
...
<div id="tabs_container" style="font-family: Verdana, Geneva, sans-serif;">
	<div id="transition" style="position:relative;"></div>

    <div id="tab_intro" style="font-size: 13px; display: block; position: relative; top: 0; left: 0; width: 100%;">
...
<div style="position:relative; height:110px; width: 600px; margin-top: 10px; width: 100%;">
  <div id="query-border"></div>
    ...
    <input type="radio" checked="checked" name= "intro_radio_location_mode" id="intro_radio_location_mode1" value="1" />
...
<div style="position: relative; height: 110px;">
  <div style="position: absolute; left: 0; width: 120px; height: 110px; padding-top: 10px; text-align: center;"> <img src="images/family_green.png" border="0"> </div>
  <div style="position: absolute; left: 120px; width:310px; height: 110px; padding-top: 10px; padding-left: 20px; font-size: 12px;"> How Many people live in your household?
...
<div style="position: relative; height: 110px;">
  <div style="position: absolute; left: 0; width: 120px; height: 110px; padding-top: 10px; text-align: center;"> <img src="images/dollar_green.png" border="0"> </div>
  <div style="position: absolute; left: 120px; width:310px; height: 110px; padding-top: 20px; padding-left: 20px; font-size: 12px;"> What is your gross annual household income? <br />
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles1"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg1" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel1"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_1">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year1" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     </td>
                     <td>
                      <select id="transportation_make1" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model1" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans1" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles2"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg2" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel2"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_2">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year2" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     ...
                     <td>
                      <select id="transportation_make2" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model2" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans2" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles3"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg3" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel3"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_3">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year3" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     ...
                     <td>
                      <select id="transportation_make3" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model3" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans3" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles4"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg4" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel4"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_4">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year4" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     ...
                     <td>
                      <select id="transportation_make4" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model4" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans4" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles5"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg5" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel5"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_5">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year5" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     ...
                     <td>
                      <select id="transportation_make5" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model5" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans5" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles6"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg6" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel6"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_6">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year6" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     ...
                     <td>
                      <select id="transportation_make6" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model6" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans6" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles7"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg7" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel7"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_7">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year7" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     ...
                     <td>
                      <select id="transportation_make7" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model7" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans7" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles8"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg8" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel8"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_8">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year8" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     ...
                     <td>
                      <select id="transportation_make8" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model8" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans8" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles9"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg9" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel9"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_9">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year9" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     ...
                     <td>
                      <select id="transportation_make9" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model9" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans9" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
    	...
    	<div align="center" style="background-color:#BDC8DF; border: 1px solid #BDC8DF;background-image:url('./images/vehicle_bg.PNG'); background-repeat: repeat-x; padding: 4px; text-align: center;">
            ...
            <tr>
            	<td>
                    ...
                    <tr>
                        ...
                        <td width="190">
                            Miles per year: 
                            <input id="input_footprint_transportation_miles10"
                             type="text" 
                             class="transportation_inputs" size="8" 
                             maxlength="5" >
                         </td>
                         <td width="300">
                            Miles per gallon: 
                            <input id="input_footprint_transportation_mpg10" type="text" 
                            class="transportation_inputs" 
                            size="3" 
                            maxlength="3" >
                            <!-- 
                         ...
                         <td width="90" align="left">
                          <select id="input_footprint_transportation_fuel10"><option value="1" selected="">Gasoline</option><option value="2">Diesel</option>          </select>
                         </td>
                    </tr>
                    </table>
                </td>
            ...
            <tr>
                <td id="transportation_vehicle_select_10">
                    ...
                    <tr>
                     <td>
                      <select id="transportation_year10" 
                      class="vehicle_select_"
                      style="width: 70px;">
                        <option value="0"> -Select- </option>
                      </select>
                     ...
                     <td>
                      <select id="transportation_make10" 
                      class="vehicle_select_" style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_model10" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
                     <td>
                      <select id="transportation_trans10" 
                      class="vehicle_select_"
                      style="width: 180px;">
                      </select>
                     </td>
...
<tr>
	<td style="padding-top: 5px; padding-left: 20px; font-size: 15px; font-weight:bold;">
        <button id="transportation_button_addvehicle" style="font-size: 10px; width: 30px">+</button><button id="transportation_button_subtractvehicle" style="font-size: 10px; width: 30px;">-</button>
    </td>
</tr>
<tr>
<td>
     ...
     <td colspan="4">
      <div id="transportation_public_transit" style="width:650px;">
       <table class="transportation_table">
        <tr>
         <td colspan="4"><div class="trans_head_test" style="width: 400px;">
         <table><tr><td>
         ...
         <INPUT TYPE="RADIO" name="transportation_groundtype" id="transportation_groundtype0" VALUE="transportation_groundtotal" />
         <label for="transportation_groundtype0"><span>Simple</span></label>
         <INPUT TYPE="RADIO" name="transportation_groundtype" id="transportation_groundtype1" VALUE="transportation_groundmulti" />
        ...
        <tr id="transportation_groundtotal">
         <td colspan="4"  style="padding-left:50px;"><input id="input_footprint_transportation_publictrans" type="text" size="12" maxlength="20" > miles per year</td>
        </tr>
        <tr id="transportation_groundmulti">
         <td colspan="4"  style="padding-left:50px;">
          <table width="100%">
           <tr>
            <td>&nbsp;<input id="input_footprint_transportation_bus" type="text"   size="12" maxlength="5" > Bus</td>
           </tr>
           <tr>
            <td>&nbsp;<input id="input_footprint_transportation_transit" type="text" size="12" maxlength="5" > Transit Rail (light&heavy)
            </td>
           </tr>
           <tr>
            <td>&nbsp;<input id="input_footprint_transportation_commuter" type="text" size="12" maxlength="5" > Commuter Rail</td>
           </tr>
           <tr>
            <td>&nbsp;<input id="input_footprint_transportation_intercity" type="text" size="12" maxlength="5" > Inter-city Rail (Amtrak)</td>
           </tr>
          </table>
         </td>
        </tr>
      ...
      <div id="transportation_air_travel" style="width:650px;">
       <table class="transportation_table">
        <tr>
         ...
         <INPUT TYPE=RADIO name="transportation_airtype" id="transportation_airtype0" VALUE="transportation_airtotal"/>
         <label for="transportation_airtype0">Simple</label>
         <INPUT TYPE=RADIO name="transportation_airtype" id="transportation_airtype1" VALUE="transportation_airmulti" /> 
        ...
        <tr id="transportation_airtotal">
         <td colspan="4" style="padding-left:50px;"><input id="input_footprint_transportation_airtotal" type="text" size="12" maxlength="6" > miles flown per year</td>
        </tr>
        <tr id="transportation_airmulti">
         <td colspan="4" style="padding-left:50px;">
          <table width="100%">
           <tr><td>Number of one-way flights</td></tr>
           <tr>
            <td>&nbsp;<input id="input_footprint_transportation_airshort" type="text" size="12" maxlength="6" > Short (&lt; 400 mi)</td>
           </tr>
           <tr>
            <td>&nbsp;<input id="input_footprint_transportation_airmedium" type="text" size="12" maxlength="6" > Medium (400-1500 mi)</td>
           </tr>
           <tr>
            <td>&nbsp;<input id="input_footprint_transportation_airlong" type="text" size="12" maxlength="6" > Long (1500 - 3000 mi)</td>
           </tr>
           <tr>
            <td>&nbsp;<input id="input_footprint_transportation_airextended" type="text" size="12" maxlength="6" > Extended (&gt; 3000 mi)</td>
           </tr>
          </table>
         </td>
        </tr>
...
<div class="radiogrp " style="font-size:11px ; padding-left: 20px;">
  <input type="radio" name="housing_calculation_type"  id="housing_calculation_type0" checked="checked" value="regular" />
...
<div id="housing_regular_container" style="padding-left: 5px; font-family:Verdana, Geneva, sans-serif;">
  <table class="general_table" cellspacing="0" cellpadding="10px" border="0" align="center" style="width: 660px;">
    <tr>
      ...
      <td style="width: 360px;"><table id="electricity_container" cellspacing="0" cellpadding="0" border="0">
          <tr>
    ...
    <tr>
      ...
      <td style="width: 360px;"><select id="input_footprint_housing_cleanpercent" >
    ...
    <tr>
      ...
      <td  style="width: 360px;" id="housing_natural_gas"><table id="electricity_container" cellspacing="0" cellpadding="0" border="0">
          <tr>
    ...
    <tr>
      ...
      <td style="width: 360px;"><input  id="input_footprint_housing_heatingoil_dollars" type="text"  size="4" maxlength="4" >
    ...
    <tr style="display: none;">
      ...
      <td id="housing_living_space"><input  id="input_footprint_housing_heatingoil_dollars_per_gallon" type="text"  size="4" maxlength="4" >
        $/Gallon</td>
    </tr>
    <tr>
      <td><span class="section_head_font">Square feet in your living space:</span></td>
      <td id="housing_living_space"><input  id="input_footprint_housing_squarefeet" type="text"  size="4" maxlength="4" ></td>
    </tr>
    <tr>
      <td style="width: 300px;"><span class="section_head_font">Water:</span></td>
      <td style="width: 360px;"><div style="position: relative; width: 260px; height: 50px;">
          <div style="position: absolute; top: 0; left: 0; width: 260px; height: 50px;">
            <table cellpadding="0" cellspacing="0" border="0" class="housing_tabl2e">
              <tr>
                <td><div id="housing_watersewage_slidertext" class="SliderText" align="center" style="width:260px;">Average</div>
                  <div id="housing_watersewage_slider" style="width:260px;">&nbsp;</div>
                  <img src="images/triangle.png"></td>
                <td style="width: 50px; padding: 20px;"><img src="images/carb_question_mark.png" border="0" class="tTip tTipHandle" title="<strong>Average daily water consumption</strong><br /><br />Average household: 64 gal./day<br />1-person household: 39 gal./day<br />2-person household: 64 gal./day<br />3-person household: 69 gal./day<br />4-person household: 79 gal./day<br />5-person household: 89 gal./day"/></td>
                <td></td>
              </tr>
            </table>
          </div>
...
<div id="housing_adv_container" style="padding-left: 5px; font-family:Verdana, Geneva, sans-serif; font-size: 12px; display: none;">
  <div style= "padding-top: 8px; padding-left: 20px;"> <span> Please enter your zip code:
    ...
    <button id="housing_button_hes_submit_zipcode" style="width: 170px; height: 25px; font-size: 12px;" onclick="javascript:housing_button_hes_submit_zipcode_onclick();">Begin Advanced Audit</button>
    </span>
...
<div style="height: 40px; display: none"></div>
    ...
    <div class="tab_title tab_title_shopping thinfont">How much do you consume of each of the following?
...
<div>Number Of Adults/Children In Your Household</div><div>
...
<div style="margin-bottom: 10px; color: #8C9DC6; font-size: 12px;">Average daily Calories</div><div>
<table><tbody><tr><td style="width: 90px; color: #8C9DC6;font-size: 12px;">Per Person</td><td style="color: #8C9DC6; font-size: 12px;">Total</td></tr></tbody></table>
</div>
</div>

<div style="margin-left: 20px; ">  <table class="shopping_table" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <td style="width: 180px;"><span style="margin-left: 20px;"><img id="shopping_state_img" src="images/icon_steak_fish.png" border="0" /> Meat, fish, eggs </span></td>
 <td><div class="radiogrp">
 ...
 <td style="width: 250px;"><div id="shopping_meatfisheggs_slidertext" class="SliderText" align="center">Average</div>
 <div id="shopping_meatfisheggs_slider"></div>
 <img src="images/triangle.png"></td>
 <td style="width: 50px;"><div id="shopping_meatfisheggs-Value" style="visibility: hidden;">$</div></td>
 ...
 <td style="width: 250px;"><div id="shopping_meat_beefpork_slidertext" class="SliderText" align="center">Average</div> 
 <div id="shopping_meat_beefpork_slider"></div>
 <img src="images/triangle.png"></td>
 <td><div id="shopping_meat_beefpork-Value" style="visibility: hidden;width: 50px;"></div></td>
 ...
 <td><div id="shopping_meat_poultry_slidertext" class="SliderText" align="center">Average</div>
 <div id="shopping_meat_poultry_slider"></div>
 <img src="images/triangle.png"></td>
 <td><div id="shopping_meat_poultry-Value" style="visibility: hidden;"></div></td>
 ...
 <td><div id="shopping_meat_fish_slidertext" class="SliderText" align="center">Average</div>
 <div id="shopping_meat_fish_slider"></div>
 <img src="images/triangle.png"></td>
 <td><div id="shopping_meat_fish-Value" style="visibility: hidden;"></div></td>
 ...
 <td><div id="shopping_meat_other_slidertext" class="SliderText" align="center">Average</div>
 <div id="shopping_meat_other_slider"></div>
 <img src="images/triangle.png"></td>
 <td><div id="shopping_meat_other-Value" style="visibility: hidden;"></div></td>
 ...
 <tr>
 <td style="width: 220px;"><span style="margin-left: 20px;"><img id="shopping_state_img" src="images/icon_cheese_milk.png" border="0"> Dairy </span></td>
 <td style="width: 250px;"><div id="shopping_dairy_slidertext" class="SliderText" align="center">Average</div>
 <div id="shopping_dairy_slider"></div>
 <img src="images/triangle.png"></td>
 <td><div id="shopping_dairy-Value" style="visibility: hidden; width: 50px;"></div></td>
 ...
 <tr>
 <td><span style="margin-left: 20px;"><img id="shopping_state_img" src="images/icon_apple.png" border="0"> Fruits & Vegetables</span></td>
 <td><div id="shopping_fruitvegetables_slidertext" class="SliderText" align="center">Average</div>
 <div id="shopping_fruitvegetables_slider"></div>
 <img src="images/triangle.png"></td>
 <td><div id="shopping_fruitvegetables-Value" style="visibility: hidden;"></div></td>
 <td id="shopping_fruitvegetables_calories_per_person"></td>
 <td id="shopping_fruitvegetables_calories_per_household"></td>
 </tr>
 <tr>
 <td><span style="margin-left: 20px;"><img id="shopping_state_img" src="images/icon_croissant.png" border="0"> Grains & Baked Goods </span></td>
 <td><div id="shopping_cereals_slidertext" class="SliderText" align="center">Average</div>
 <div id="shopping_cereals_slider"></div>
 <img src="images/triangle.png"></td>
 <td><div id="shopping_cereals-Value" style="visibility: hidden;"></div></td>
 <td id="shopping_cereals_calories_per_person"></td>
 <td id="shopping_cereals_calories_per_household"></td>
 </tr>
 <tr>
 <td><span style="margin-left: 20px;"><img id="shopping_state_img" src="images/icon_ice_cream.png" border="0"> Other (snacks,drinks,etc.)</span></td>
 <td><div id="shopping_otherfood_slidertext" class="SliderText" align="center">Average</div>
 <div id="shopping_otherfood_slider"></div>
 <img src="images/triangle.png"></td>
 <td><div id="shopping_otherfood-Value" style="visibility: hidden;"></div></td>
 <td id="shopping_otherfood_calories_per_person"></td>
 <td id="shopping_otherfood_calories_per_household"></td>
 </tr>
 <tr>
 <td></td>
 <td><div id="shopping_totalcalories_slider"></div></td>
 <td><div id="shopping_totalcalories-Value"><strong>Total</strong></div></td>
...
<div style="height: 50px; display: none"></div>    </div>
    
    <div id="tab_shopping" style="font-size: 13px; display: none; position: relative; top: 0; left: 0;width: 100%;">
    <div class="tab_title tab_title_shopping thinfont">How much do you spend on each of the following?
...
<table class="shopping_table" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="width: 180px;"><span class="section_head_font">Goods</span> <img src="images/carb_question_mark.png" border="0" class="tTip tTipHandle" title="Default values for goods are based on households with similar size and income, living in the same location. We recommend that you use the default values or modify them based on your own estimate of how much you spend on each item compared to similar households." /> <span class="section_text_font" style="margin-left: 8px;">$/month</span></td>
    <td><div class="radiogrp">
...
<table class="shopping_table" id="goods_total" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td style="width: 250px; height: 60px;"><div id="goods_slidertext" class="SliderText" align="center">Average</div>
      <div id="goods_slider"></div>
      <img src="images/triangle.png">
      <div id="goods-Value"  style="visibility: hidden;"></div></td>
  </tr>
</table>
<table class="shopping_table" id="goods_multi" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>$
      ...
      <div id="furnitureappliances_slider"></div></td>
  </tr>
  <tr>
    <td colspan="2"><table class="shopping_table" border="0" cellspacing="0" cellpadding="0">
        <tr>
  ...
  <tr>
    <td colspan="2"><table class="shopping_table" id="othergoods_total" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td style="width: 220px; padding-bottom: 20px;"><span style="margin-left: 40px;">Total Other Goods</span></td>
          <td style="width: 250px; padding-bottom: 20px;">$
            <input type="text" id="input_footprint_shopping_goods_other_total"
                  size="5" maxlength="9">
            <div id="other_goods_slider"></div></td>
        </tr>
      </table>
      <table class="shopping_table" id="othergoods_multi" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="width: 250px;">$
            <input type="text" id="input_footprint_shopping_goods_other_entertainment" 
                 size="5" maxlength="9">
            <div id="entertainment_slider"></div></td>
        </tr>
        <tr>
          <td style="width: 220px;"><span style="margin-left: 40px;">Paper, office & reading</span></td>
          <td style="width: 250px;">$
            <input type="text" id="input_footprint_shopping_goods_other_office" 
                 size="5" maxlength="9">
            <div id="office_slider"></div></td>
        </tr>
        <tr>
          <td style="width: 220px;"><span style="margin-left: 40px;">Personal care & cleaning</span></td>
          <td style="width: 250px;">$
            <input type="text" id="input_footprint_shopping_goods_other_personalcare" 
                 size="5" maxlength="9">
            <div id="personalcare_slider"></div></td>
        </tr>
        <tr>
          <td style="width: 220px;"><span style="margin-left: 40px;">Auto parts </span></td>
          <td style="width: 250px;">$
            <input type="text" id="input_footprint_shopping_goods_other_autoparts"  
                size="5" maxlength="9">
            <div id="autoparts_slider"></div></td>
        </tr>
        <tr>
          <td style="width: 220px;"><span style="margin-left: 40px;">Medical </span></td>
          <td style="width: 250px;">$
            <input type="text" id="input_footprint_shopping_goods_other_medical"  
                size="5" maxlength="9">
            <div id="medical_slider"></div></td>
        </tr>
      </table></td>
  </tr>
</table>
<table class="shopping_table" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="width: 180px;"><span class="section_head_font">Services</span> <img src="images/carb_question_mark.png" border="0" class="tTip tTipHandle" title="Default values for services are based on households with similar size and income, living in the same location. We recommend that you use the default values or modify them based on your own estimate of how much you spend on each item compared to similar households." /></span><span class="section_text_font" style="margin-left: 8px;">$/month</span></td>
    <td><div class="radiogrp">
...
<table class="shopping_table"  id="services_total" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td style="width: 250px;height: 60px;"><div id="services_slidertext" class="SliderText" align="center">Average</div>
      <div id="services_slider"></div>
      <img src="images/triangle.png">
      <div id="services-Value"  style="visibility: hidden;"></div></td>
  </tr>
</table>
<table class="shopping_table" id="services_multi" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td style="width: 250px;">$
      <input type="text" id="input_footprint_shopping_services_healthcare"  
        size="5" maxlength="9" >
      <div id="healthcare_slider"></div></td>
  </tr>
  <!--
    <tr>
      <td style="width: 220px;"><span style="margin-left: 20px;">Entertainment & Recreation</span></td>
      <td style="width: 250px;">$
        <input type="text" id="input_footprint_shopping_services_recreation"  
        size="5" maxlength="9">
        <div id="recreation_slider"></div></td>
    </tr>
    -->
  <tr>
    <td style="width: 220px;"><span style="margin-left: 20px;">Education</span></td>
    <td style="width: 250px;">$
      <input type="text" id="input_footprint_shopping_services_education"  
        size="5" maxlength="9">
      <div id="education_slider"></div></td>
  </tr>
  <tr>
    <td style="width: 220px;"><span style="margin-left: 20px;">Information & Communication</span></td>
    <td style="width: 250px;">$
      <input type="text" id="input_footprint_shopping_services_communications"  size="5" 
        maxlength="9">
      <div id="communications_slider"></div></td>
  </tr>
  <tr>
    <td style="width: 220px;"><span style="margin-left: 20px;">Vehicle services</span></td>
    <td style="width: 250px;">$
      <input type="text" id="input_footprint_shopping_services_vehicleservices"  
        size="5" maxlength="9">
      <div id="vehicleservices_slider"></div></td>
  </tr>
  <tr>
    <td style="width: 220px;"><span style="margin-left: 20px;">Personal business & finance</span></td>
    <td style="width: 250px;">$
      <input type="text" id="input_footprint_shopping_services_finance"  size="5"
         maxlength="9">
      <div id="finance_slider"></div></td>
  </tr>
  <tr>
    <td style="width: 220px;"><span style="margin-left: 20px;">Household maintenance & Repair</span></td>
    <td style="width: 250px;">$
      <input type="text" id="input_footprint_shopping_services_household"  
        size="5" maxlength="9">
      <div id="household_slider"></div></td>
  </tr>
  <tr>
    <td style="width: 220px;"><span style="margin-left: 20px;">Organizations & Charity</span></td>
    <td style="width: 250px;">$
      <input type="text" id="input_footprint_shopping_services_charity"  
        size="5" maxlength="9">
      <div id="charity_slider"></div></td>
  </tr>
  <tr>
    <td style="width: 220px;"><span style="margin-left: 20px;">Miscellaneous services</span></td>
    <td style="width: 250px;">$
      <input type="text" id="input_footprint_shopping_services_miscservices"
          size="5" maxlength="9">
      <div id="miscservices_slider"></div></td>
  </tr>
</table>
...
<p>
    <a href="http://www.climateearth.com" target="_blank" style="border: none;">
        <img style="float: right" src="images/ClimateEarthLogoSmall.png"
            style="border: none" />
    </a>
    ...
    <div style="position: relative">
<div class="tab_title tab_title_takeaction thinfont">Build your action plan</div>
<script>
function printpage()
  {
  window.print()
...
<div style="color: #7DC100; font-size:15px; font-weight: bold;width: 100%; text-align: center;">Total Reductions</div>
...
<div style="color: #5A75AD; font-size:15px; font-weight: bold;width: 100%; text-align: center; color: #5A75AD; margin-top: 10px;">Total Footprint</div>
...
<div style="font-family: Verdana, Geneva, sans-serif; font-size: 11px; position: absolute; top: 350px;"> <a href="javascript:;" id="takeaction_reset_chart" title="Click here to reset the height of the graph" class="tTip tTipHandle" style="color: #666; text-decoration: none;"> Reset Axis </a> </div>
...
onMouseOver="if (!animating) {$('#tooltip1b').hide();}" 
onMouseMove="if (!animating) {$('#tooltip1b').hide();}">
<div id="takeaction_tooltip_text" style="margin-top: 25px; text-align: center; font-family: Verdana, Geneva, sans-serif;  font-size: 12px; color: #333;margin-left: 25px; width: 100px;;"></div></div>
...
<div>Tons</div><div>Saved</div><div style="position: absolute; right: 10px; top: 10px;">
<span style="display:none;" class="takeaction_sortbutton_arrow takeaction_sortbutton_uparrow">↑</span>
<span style="display:none;" class="takeaction_sortbutton_arrow takeaction_sortbutton_downarrow">↓</span>
</div></div>
...
<div class="takeaction_sortbutton_text" style="padding-top: 4px; text-align: center; width: 100%;">
<div>Dollars</div><div>Saved</div><div style="position: absolute; right: 10px; top: 10px;">
<span style="display:none;" class="takeaction_sortbutton_arrow takeaction_sortbutton_uparrow">↑</span>
<span style="display:none;" class="takeaction_sortbutton_arrow takeaction_sortbutton_downarrow">↓</span>
</div></div>
<div style="color: #999; font-size: 10px; text-align: center; width: 100%;">
...
<div class="takeaction_sortbutton" id="takeaction_sortbutton_net10yr" style="cursor: pointer;
 position: relative;margin-left: 10px;width: 90px; height: 55px; border-radius: 5px; border: 1px solid #BBB">
<div class="takeaction_sortbutton_text" style="padding-top: 4px; text-align: center; width: 100%;">
<div>Upfront</div><div>Cost</div><div style="position: absolute; right: 10px; top: 10px;">
<span style="display:none;" class="takeaction_sortbutton_arrow takeaction_sortbutton_uparrow">↑</span>
<span style="display:none;" class="takeaction_sortbutton_arrow takeaction_sortbutton_downarrow">↓</span>
</div></div>
<div style="color: #999; font-size: 10px; text-align: center; width: 100%;">
	...
	<div class="new takeaction_section_transportation">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_more_efficient_vehicle" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_more_efficient_vehicle"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_more_efficient_vehicle"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <img src="images/pledges/icon1.png" alt="Car Icon" align="right" vspace="5" hspace="10" />I will trade in
...
<input type="text" id="input_takeaction_more_efficient_vehicle_miles_new" size="5" maxlength="6" />
...
<div class="funfact">Americans are choosing greener vehicles--the average fuel efficiency of cars on the road in the U.S. has gone up steadily for the past 10 years. Don't get left behind in a gas guzzler! </div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/home+electricity//false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
<div class="assumption_button">
  <a href="javascript:;" class="assumptionShowHideLink">[<span class="takeaction_assumption_plusminus">+</span>] assumptions</a>
</div>
<div class="assumption_content">
  <ul>
    <li>Price of gasoline: $ <span class="pledge_assumption_price_of_gasoline"> </span> per gallon <img src="images/carb_question_mark.png" alt="" border="0" title= "Click the Assumptions button above to change the price of gas." class="tTip tTipHandle" /> </li>
    <li>Well-to-pump emissions: 20% of fossil fuel emissions. This includes emissions from the fuel used to find, extract, transport and refine crude oil into gasoline </li>
    <li>Greenhouse gas emissions from vehicles manufacturing: 53 grams CO2e per mile (8 metric tons per vehicle / 150,000 miles lifespan)</li>
    <li>Not included: emissions from road construction and maintenance, and other government-related emissions</li>
  </ul>
</div>
	...
	<div class="new takeaction_section_transportation">
        <h>
          <table style="margin-top: 5px;" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <td><a class="chkPledge" id="chkPledge_alternativefuel_vehicle" style="display: block;" href="javascript:takeaction_pledge('alternativefuel_vehicle');">
                <table align="center" class="trg" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        <td class="chkPledge" style="height: 30px;"> Pledge </td>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_alternativefuel_vehicle" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_alternativefuel_vehicle"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_alternativefuel_vehicle"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/altfuel.png" alt="Alternative Fuel Vehicle" align="right" vspace="5" hspace="10" />
I will trade in
...
miles per gallon. <p>I will drive this vehicle
<input type="text" id="input_takeaction_alternativefuel_vehicle_miles_new" size="5" maxlength="6" />
miles per year. Alternative fuel will cost $<input type="text" id="input_takeaction_alternativefuel_vehicle_new_fuel_cost" size="4" maxlength="4" />/gal.
...
<div class="assumption_content">
  <ul>
    <li>Price of gasoline: $ <span class="pledge_assumption_price_of_gasoline">0</span> per gallon <img src="images/carb_question_mark.png" alt="" border="0" title= "Click the Assumptions button above to change the price of gas." class="tTip tTipHandle" /> </li>
    <li>Well-to-pump emissions: 20% of fossil fuel emissions. This includes emissions from the fuel used to find, extract, transport and refine crude oil into gasoline </li>
    <li>Greenhouse gas emissions from vehicles manufacturing: 53 grams CO2e per mile (8 metric tons per vehicle / 150,000 miles lifespan)</li>
    <li>Alternative fuel: CNG</li>
    <li>A number of rebates are available for alternative fuel vehicles from state, federal and local agencies. We assume $2,000 rebate per vehicle is available at the time of purchase</li>
    <li>Not included: emissions from road construction and maintenance, and other government-related emissions</li>
  </ul>
</div>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_electric_vehicle" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_electric_vehicle"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_electric_vehicle"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<div class="assumption_content">
  <ul>
    <li>Price of gasoline: $ <span class="pledge_assumption_price_of_gasoline">0</span> per gallon <img src="images/carb_question_mark.png" alt="" border="0" title= "Click the Assumptions button above to change the price of gas." class="tTip tTipHandle" /> </li>
    <li>Greenhouse gas emissions from vehicles manufacturing: 53 grams CO2e per mile (8 metric tons per vehicle / 150,000 miles lifespan)</li>
    <li>Price of electricity: <span class="kwhprice">0</span> (cents/kWh) <img src="images/carb_question_mark.png" border="0" title="Click the Assumptions button above to change the price of electricity." class="tTip tTipHandle" /> </li>
    <li>A number of rebates are available for alternative fuel vehicles from state, federal and local agencies. We assume $2,000 rebate per vehicle is available at the time of purchase</li>
    <li>Not included: emissions from road construction and maintenance, and other government-related emissions</li>
  </ul>
</div>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_hybrid_vehicle" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_hybrid_vehicle"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_hybrid_vehicle"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_telecommute_to_work" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_telecommute_to_work"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_telecommute_to_work"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
which gets <span id="display_takeaction_telecommute_to_work_mpg">0</span> miles per gallon. </p>
...
<p>I will save
  ...
  per hour to me.<img src="images/carb_question_mark.png" border="0" title="The value you would be willing to pay per hour to avoid commuting to work." class="tTip tTipHandle"/></p>
<div class="funfact">Not every job is suited for telecommuting, but if you can work from home the environmental and quality-of-life perks are quite compelling! </div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/water+heater//false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
<div class="assumption_button">
<a href="javascript:;" class="assumptionShowHideLink">[<span class="takeaction_assumption_plusminus">+</span>] assumptions</a>
...
<div class="assumption_content">
  <ul>
    <li>Price of gasoline: $<span span class="pledge_assumption_price_of_gasoline">0</span> per gallon <img src="images/carb_question_mark.png" border="0" title="Click the Assumptions button above to change the price of gas." class="tTip tTipHandle"/></li>
  </ul>
</div>

<input type="hidden" id="input_takeaction_telecommute_to_work_mpg" />              </div>
	...
	<div class="new takeaction_section_transportation">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_ride_my_bike" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_ride_my_bike"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_ride_my_bike"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/icon3.png" alt="" align="right" vspace="5" hspace="10"/> <span>I will ride my bike
...
<div class="funfact"> Your bicycle can make you a lean, green clean-moving machine! Free tools like google maps have bike-friendly directions to get you going as an exemplary neighborhood cyclist. </div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BCategory%253D%253DTransportation%255D%255BEligible+Applicants%253D%253DIndividual%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
<div style="padding:0px; overflow: auto;"><span> </span>
  ...
  <div class="assumption_content">
    <div>
      <ul>
        <li>Price of gasoline:$<span class="pledge_assumption_price_of_gasoline">0</span> per gallon <img src="images/carb_question_mark.png" border="0" title="Click the Assumptions button above to change the price of gas." class="tTip tTipHandle"/> </li>
        <li>You currently consume about <span id="result_takeaction_ride_my_bike_totalcalories">0</span> calories
          per day with a corresponding carbon footprint of about <span id="result_takeaction_ride_my_bike_ghgper100cal">0</span> grams of CO2e per
          100 calories </li>
        <li> Riding your bicycle <span id="display_takeaction_ride_my_bike_miles">0</span> miles per week therefore produces
          about <span id="result_takeaction_ride_my_bike_bikeghgs">0</span> mtCO2e/yr </li>
        <li>Driving your vehicle the same distance produces <span id="result_takeaction_ride_my_bike_driveghgs">0</span> mtCO2e/yr </li>
      </ul>
      <p>Growing, processing and distributing food
        produces greenhouse gases. The average
        American consumes about about 300 - 500 unnecessary calories per day, and riding a bicycle burns about 400
        calories per hour, so most people could ride a
        bicycle for about one hour per day without increasing calorie intake. However, if you do not take in surplus calories and would need to eat more to fuel bicycle riding, then
...
<input type="hidden" id="input_takeaction_ride_my_bike_mpg" />              </div>
	...
	<div class="new takeaction_section_transportation">
        <h>
          <table style="margin-top: 5px;" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <td><a class="chkPledge" id="chkPledge_take_public_transportation" style="display: block;" href="javascript:takeaction_pledge('take_public_transportation');">
                <table align="center" class="trg" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        <td class="chkPledge" style="height: 30px;"> Pledge </td>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_take_public_transportation" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_take_public_transportation"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_take_public_transportation"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
               <img src="images/pledges/icon4.png" alt="" align="right" vspace="5" hspace="10"/> <span>I will take
...
<input type="text" id="input_takeaction_take_public_transportation_miles" size="3" maxlength="3" />
miles per week instead of driving
...
which gets <span id="display_takeaction_take_public_transportation_mpg"> 0 </span> miles per gallon. 
	I will save $
<input type="text" id="input_takeaction_take_public_transportation_parking" size="3" maxlength="3" />
on parking and spend $
<input type="text" id="input_takeaction_take_public_transportation_ptfare" size="3" maxlength="3" />
per week on public transportation.
<div class="funfact"> Riding transit frees you from the stress of navigating traffic and provides time for work, catching up on the news or finally getting around to that book you've been meaning to read.</div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BCategory%253D%253DTransportation%255D%255BEligible+Applicants%253D%253DIndividual%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
...
<div class="assumption_content">
  <div>
    ...
    <ul>
      ...
      <ul>
        <li> Diesel bus
          <input id="input_takeaction_take_public_transportation_gco2bus" type="text" size="3" maxlength="3"/>
          , average occupancy of bus is 11 passengers </li>
        <li> Natural gas bus
          <input id="input_takeaction_take_public_transportation_gco2ngbus" type="text" size="3" maxlength="3" />
          , average occupancy is 11 passengers</li>
        <li> Electric transit rail
          <input id="input_takeaction_take_public_transportation_gco2transit" type="text" size="3" maxlength="3" />
          , average occupancy is 37 passengers per rail car </li>
        <li> Amtrak
          <input id="input_takeaction_take_public_transportation_gco2amtrak" type="text" size="3" maxlength="3" />
	...
	<div class="new takeaction_section_transportation">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_practice_eco_driving" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_practice_eco_driving"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_practice_eco_driving"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/icon5.png" alt="" align="right" vspace="5" hspace="10"/><span>I currently drive a total of <span id="result_takeaction_practice_eco_driving_dispmiles"> 0 </span> miles per year, of which
<input name="hwpercent" type="text" id="input_takeaction_practice_eco_driving_hwpercent" size="2" maxlength="2" />
% are highway miles.
The average fuel economy of my vehicles is <span id="result_takeaction_practice_eco_driving_mpg"> 0 </span> miles per gallon. 
	  Reducing my top cruising highway speed from
<input name="topspeed" type="text" id="input_takeaction_practice_eco_driving_topspeed" size="2" maxlength="2" />
mph to
<input name="lowerspeed" type="text" id="input_takeaction_practice_eco_driving_lowerspeed" size="2" maxlength="2" />
mph will improve my fuel
	  ...
	  Together these actions will improve my fuel economy to <span class="newmpg" id="result_takeaction_practice_eco_driving_newmpg"> 0 </span> miles per gallon,
	  saving <span class="galsaved" id="result_takeaction_practice_eco_driving_galsaved"> 0 </span> gallons per year.
</span>
<div class="funfact"> Most car engines get less and less efficient as speeds increase. Smart speed management levels off emissions on the freeway and helps prevent ticket troubles. </div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BCategory%253D%253DTransportation%255D%255BEligible+Applicants%253D%253DIndividual%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
  ...
  <div>
    <ul>
      <li>Price of gasoline:
        $<span class="pledge_assumption_price_of_gasoline" >0</span> per gallon <img src="images/carb_question_mark.png" border="0" title="Click the Assumptions button above to change the price of gas." class="tTip tTipHandle" /></li>
      <li> Average top cruising speed represents
        <input type="text" id="input_takeaction_practice_eco_driving_topspercent" size="2" maxlength="2" />
        % of highway miles </li>
    </ul>
  </div>
</div>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_maintain_my_vehicles" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_maintain_my_vehicles"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_maintain_my_vehicles"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
I currently drive a total of <span id="result_takeaction_maintain_my_vehicles_dispmiles"> 0 </span> miles per year, with an average fuel economy of 
...
<div class="funfact">
Taking care of your car keeps you on the road instead of at the shop. Plus, your smoothly running machine trims pounds of your carbon footprint. 
</div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BCategory%253D%253DTransportation%255D%255BEligible+Applicants%253D%253DIndividual%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
	...
	<div>
	  ...
	  <img src="images/carb_question_mark.png" border="0" title="Click the Assumptions button above to change the price of gas." class="tTip tTipHandle" /></li>
	  <li>Keeping tires inflated improves fuel efficiency by 
	  <input name="tirespercent" type="text" id="input_takeaction_maintain_my_vehicles_tirespercent" size="3" maxlength="3" /> percent</li>
	  <li>Changing air filters regularly improves fuel efficiency by <input name="filterpercent" type="text" id="input_takeaction_maintain_my_vehicles_filterpercent" size="3" maxlength="3" /> percent </li>
	  <li>Keeping tires inflated costs $<input name="tirescost" type="text" id="input_takeaction_maintain_my_vehicles_tirescost" size="2" maxlength="2" /></li>
	 <li> Changing air filters regularly costs $
	  <input name="filtercost" type="text" id="input_takeaction_maintain_my_vehicles_filtercost" size="3" maxlength="3" /> </li>
      </ul>
	  <!--from bizcalc-->
	</div>
    </div>              </div>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_carpool_to_work" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_carpool_to_work"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_carpool_to_work"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<img src="images/pledges/icon7.png" alt="" align="right" hspace="5" vspace="10"/> I  usually drive alone in a
...
<div class="funfact">Get in the Fast Lane! One of the major benefits of carpooling is that you get access to the carpool-only lanes on the freeway. </div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BCategory%253D%253DTransportation%255D%255BEligible+Applicants%253D%253DIndividual%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
...
<div class="assumption_content">
  <div> 
    ...
    <ul>
      ...
      <li>Depreciation per mile for vehicle driven: $ <span id="result_takeaction_carpool_to_work_dep1k"> </span><img src="images/carb_question_mark.png" border="0" title="Based on type and age of vehicle, which you can set under the Transportation tab. Depreciation per mile only includes value lost from driving additional miles. It does not include depreciation from the aging of vehicles" class="tTip tTipHandle"/> </li>
    </ul>
  </div>
</div>
              </div>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_reduce_air_travel" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_reduce_air_travel"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_reduce_air_travel"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
I fly about <span id="result_takeaction_reduce_air_travel_totalmiles">0</span> miles per year, which produces about <span id="result_takeaction_reduce_air_travel_pounds_from_flight">0</span> tons of CO2e per year. 
	I will fly
...
or <span id="result_takeaction_reduce_air_travel_miles_alt">0</span> fewer miles per year by teleconferencing or staying home.
<div class="funfact"> Travelling virtually is one of the best things you can do to reduce you impacts because every two-hours flight avoided saves as much as avoiding a month of typical driving. </div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BCategory%253D%253DTransportation%255D%255BEligible+Applicants%253D%253DIndividual%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
...
<div class="assumption_content">
  <div>
    <ul>
      <li> Flying produces 223 grams of CO2e/passenger mile, on average (<a href="http://ghgprotocol.org">WRI-WBCSD</a>) </li>
      <li>Indirect emissions (from contrails and other atmospheric effects) account for 50% of total emissions </li>
    </ul>
  </div>
</div>
              </div>
	...
	<div class="new takeaction_section_offset">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_offset_transportation" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_offset_transportation"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_offset_transportation"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/icon9.png" alt="" align="right" vspace="5" hspace="10"/> I have already pledged to reduce my transportation footprint by 
<span id="result_takeaction_offset_transportation_transpledges">0</span> metric tons of CO2e per year. I will purchase carbon offsets for the remaining <span id="result_takeaction_offset_transportation_transtonsleft">0</span> tons of CO2e at a cost of <input type="text" id="input_takeaction_offset_transportation_offset" size="2" maxlength="2" />
dollars per metric ton.
<div class="funfact"> Avoiding GHG emissions in one place can "offset" GHG emissions occurring somewhere else. Offsets can go toward projects such as financing a wind turbine in Asia, a solar roof-top in Africa or a reforestation program in South America. Plus, carbon offset projects can produce positive quality-of-life impacts such as increasing economic and social development and supporting clean technology. </div>
<div class="assumption_button">
  <a href="javascript:;" class="assumptionShowHideLink">[<span class="takeaction_assumption_plusminus">+</span>] assumptions</a>
</div>
<div class="assumption_content">
  <div>
    <ul>
      <li> Offsets are assumed to be "additional" greenhouse gas emissions that would NOT otherwise be reduced without your purchase of carbon offsets. Examples include projects that would not be profitable, and therefore not undertaken, without the additional funds provided by carbon offset sponsors</li>
    </ul>
  </div>
</div>
              </div>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_switch_to_cfl" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_switch_to_cfl"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_switch_to_cfl"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<p>
CFL's contain mercury so be sure to dispose of them safely. Visit the <a href="http://www2.epa.gov/cfl/recycling-and-disposal-after-cfl-burns-out">EPA</a> website to learn more.  	
	
</p>

<div class="funfact">Everyone knows CFL's are a better lightning investment. If you have any incadescents left in your house, they're slurping away four times more energy than their efficient CFL relatives for the same brightness. </div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/home+electricity//false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_turn_off_lights" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_turn_off_lights"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_turn_off_lights"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LITE/lightoff.png" alt="Turn off the Lights" align="right" vspace="5" hspace="10"/>
<p>I will turn off 
  ...
  <select id="input_takeaction_turn_off_lights_watts">
   ...
   hours a day. </p>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BEligible+Applicants%253D%253DIndividual%255D%255BCategory%253D%253DEnergy%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_T12toT8" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_T12toT8"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_T12toT8"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/T12toT8light.png" alt="Upgrading T12 with T8 Lights" align="right" vspace="5" hspace="10"/> 
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_tankless_water_heater" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_tankless_water_heater"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_tankless_water_heater"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LITE/tankless_heater.png" alt="Tankless Water Heater" align="right" vspace="5" hspace="10"/>
<p>My water heater is usually set to  
  ...
  <select id="input_takeaction_tankless_water_heater_fueltype">
   ...
   I will replace my existing  
	<input id="input_takeaction_tankless_water_heater_replacements" type="text" size="2" maxlength="2" />
	waterheater(s) with new natural gas heater(s) that cost $
	<input id="input_takeaction_tankless_water_heater_replacement_cost" type="text" size="3" maxlength="3" />
	each
   </p>
   <div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/water+heater//false/none/false/1/12">Find rebates and incentives for this action</a>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_thermostat_winter" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_thermostat_winter"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_thermostat_winter"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<img src="images/pledges/icon11.png" alt="" align="right" vspace="5" hspace="10"/> I heat my home with: <span style="">
<select  id="input_takeaction_thermostat_winter_fueltype">
  <option value="0">natural gas</option>
  <option value="1">electricity</option>
  <option value="2">fuel oil</option>
</select>
Typical <span id="display_takeaction_thermostat_winter_sqft">0</span> square foot homes in my climate spend $<span id="result_takeaction_thermostat_winter_dollarstypical">0</span> per year on heating.I heat my home about
...
of typical households, or $<span id="result_takeaction_thermostat_winter_dollarsuse">0</span> per year. 
...
<div class="funfact">Smart settings on your thermostat is one of the best things you can do to save energy because heating is the largest single contributor to energy use in typical homes, even in many moderate climates. </div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BEligible+Applicants%253D%253DIndividual%255D%255BCategory%253D%253DEnergy%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
...
<div class="assumption_content">
  <div>
    <ul>
      <li> Price of electricity: <span class="kwhprice">0</span> cents/kWh (based on your location)</li>
      <li> Price of natural gas (cents/therm): <span class="ngprice">0</span></li>
      <li> Price of fuel oil (cents/gallon):
        <input  type="text" id="input_takeaction_thermostat_winter_fueloilprice" size="3" maxlength="3" />
      </li>
      ...
      <ul>
        <li>Weekdays during the day:
          <input  type="text" id="input_takeaction_thermostat_winter_wdsetup" size="2" maxlength="2" />
        </li>
        <li> Weekdays at night:
          <input  type="text" id="input_takeaction_thermostat_winter_wdntsetup" size="2" maxlength="2" />
        </li>
        <li> Weekends during the day:
          <input  type="text" id="input_takeaction_thermostat_winter_wesetup" size="2" maxlength="2" />
        </li>
        <li> Weekends at night:
          <input  type="text" id="input_takeaction_thermostat_winter_wentsetup" size="2" maxlength="2" />
        </li>
      </ul>
      <li> Consumption Intensity: <span id="result_takeaction_thermostat_winter_intensity">0 </span> physical units*1000 / (HDD*sqft/1000)</li>
      <li> Emissions per physical unit of fuel: <span id="result_takeaction_thermostat_winter_gCO2fueltype">0 </span> gCO2e</li>
      <li> Physical units: kWh of electricity; cubic feet of natural gas; gallons of fuel oil</li>
      <li> Annual energy consumption in physical units of selected fuel type: <span id="result_takeaction_thermostat_winter_pu">0 </span></li>
      <input  type="hidden" id="input_takeaction_thermostat_winter_ngheating" size="2" maxlength="2" />
      <input  type="hidden" id="input_takeaction_thermostat_winter_elecheating" size="2" maxlength="2" />
      <input  type="hidden" id="input_takeaction_thermostat_winter_oilheating" size="2" maxlength="2" />
    </ul>
  </div>
</div>
<div style="display:none;"> Weekday hours with no temperature set: <span class="wdnoset" id="input_takeaction_thermostat_winter_wdnoset">0</span> Weekday hours with temperature set: <span class="weekendnoset" id="input_takeaction_thermostat_winter_weekendnoset">0</span> 
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_thermostat_summer" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_thermostat_summer"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_thermostat_summer"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/icon12.png" alt="" align="right" hspace="10" vspace="5"/> Typical <span id="display_takeaction_thermostat_summer_sqft">0</span> square foot homes in my climate spend $<span id="result_takeaction_thermostat_summer_dollarstypical">0 </span> (<span id="result_takeaction_thermostat_summer_kwhtypical">0 </span> kWh) per year on air conditioning. I use the AC about
...
<div class="funfact"> If you don't already do this, setting your thermostat to a neutral temperature while you're gone at work can results in an immediate 10% savings on energy. Don't let your energy dollars seep away while you're busy earning 'em! </div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BEligible+Applicants%253D%253DIndividual%255D%255BCategory%253D%253DEnergy%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
  ...
  <div>
    <ul>
      ...
      <ul>
        <li>Number of hours with temperature set for:</li>
        <li> Weekdays during the day:
          <input type="text" id="input_takeaction_thermostat_summer_wdsetup" size="2" maxlength="2" />
        </li>
        <li> Weekdays at night:
          <input type="text" id="input_takeaction_thermostat_summer_wdntsetup" size="2" maxlength="2" />
        </li>
        <li> Weekends during the day:
          <input type="text" id="input_takeaction_thermostat_summer_wesetup" size="2" maxlength="2" />
        </li>
        <li> Weekends at night:
          <input type="text" id="input_takeaction_thermostat_summer_wentsetup" size="2" maxlength="2" />
        </li>
      </ul>
    </ul>
  </div>
</div>
<div style="display:none;">Weekday hours with no set-up: <span class="wdnoset" id="input_takeaction_thermostat_summer_wdnoset">0</span> Weekday hours with no set-up: <span class="weekendnoset" id="input_takeaction_thermostat_summer_weekendnoset">0</span> 
	...
	<div class="new takeaction_section_housing">
        <h>
          <table style="margin-top: 5px;" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <td><a class="chkPledge" id="chkPledge_purchase_high_efficiency_cooling" style="display: block;" href="javascript:takeaction_pledge('purchase_high_efficiency_cooling');">
                <table align="center" class="trg" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        <td class="chkPledge" style="height: 30px;"> Pledge </td>
                ...
                <td><a class="trigger" style="display: block;" href="javascript:;">
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        <td class="pledgeText" style="width: 315px;">Purchase High Efficiency Cooling Equipment</td>
                        <!--
                        <td style="width: 50px; text-align: left;"><img src="images/categories/transportation32.png" style="width: 23px; height: 23px;"/></td>
                        -->
                        
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_purchase_high_efficiency_cooling" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_purchase_high_efficiency_cooling"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_purchase_high_efficiency_cooling"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/eff_cooling.png" alt="Purchase High Efficiency Cooling" align="right" hspace="10" vspace="5"/> 
<p>A typical <span id="display_takeaction_purchase_high_efficiency_cooling_sqft">0</span> square foot home in my climate spends $<span id="result_takeaction_purchase_high_efficiency_cooling_dollarstypical">0 </span> (<span id="result_takeaction_purchase_high_efficiency_cooling_kwhtypical">0</span> kWh) per year on air conditioning. I use the AC about
...
of typical households, or $<span id="result_takeaction_purchase_high_efficiency_cooling_dollarsuse">0 </span> 
      (<span id="result_takeaction_purchase_high_efficiency_cooling_kwhuse">0 </span> kWh) per year. <br/>
      I will replace my conventional air conditioner(s) that have a SEER rating of <input id="input_takeaction_purchase_high_efficiency_cooling_conventional_rating" type="text" size="2" maxlength="2" /> 
      with Energy Star air conditioner(s) that have a SEER rating of <input id="input_takeaction_purchase_high_efficiency_cooling_energystar_rating" type="text" size="2" maxlength="2" />.
</p>
<p>
<a href="http://energy.gov/energysaver/articles/central-air-conditioning">SEER Ratings</a>	
</p>     
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/cooling//false/none/false/1/12 ">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
...
<div class="assumption_content">
  <div>
    <ul>
      <li> Price of electricity (cents/kWh): <span class="kwhprice">0</span></li>
      <li> Cooling degree-days:
        <input type="text" id="input_takeaction_purchase_high_efficiency_cooling_cdd" size="4" maxlength="4" />
      </li>
      <li> The cost difference between a conventional air conditioner and an energy star air conditioner is
          <input type="text" id="input_takeaction_purchase_high_efficiency_cooling_cost_difference" size="5" maxlength="5" />
          dollars
        </li>
      </ul>
  </div>
	...
	<div class="new takeaction_section_housing">
        <h>
          <table style="margin-top: 5px;" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <td><a class="chkPledge" id="chkPledge_purchase_high_efficiency_heating" style="display: block;" href="javascript:takeaction_pledge('purchase_high_efficiency_heating');">
                <table align="center" class="trg" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        <td class="chkPledge" style="height: 30px;"> Pledge </td>
                ...
                <td><a class="trigger" style="display: block;" href="javascript:;">
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        <td class="pledgeText" style="width: 315px;">Purchase High Efficiency Heating Equipment</td>
                        <!--
                        <td style="width: 50px; text-align: left;"><img src="images/categories/transportation32.png" style="width: 23px; height: 23px;"/></td>
                        -->
                        
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_purchase_high_efficiency_heating" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_purchase_high_efficiency_heating"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_purchase_high_efficiency_heating"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<img src="images/pledges/LGDST/eff_heating.png" alt="Purchase High Efficiency Heating" align="right" vspace="5" hspace="10"/>
...
Typical <span id="display_takeaction_purchase_high_efficiency_heating_sqft">0</span> square foot homes in my climate spend $<span id="result_takeaction_purchase_high_efficiency_heating_dollarstypical">0</span> per year on heating. I heat my home about
...
of typical households, or $<span id="result_takeaction_purchase_high_efficiency_heating_dollarsuse">0</span> per year. 
</span>
</p>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/heating//false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
...
<div class="assumption_content">
  <div>
    <ul>
      ...
      <li> Price of natural gas (cents/therm): <span class="ngprice">0</span></li>
      <li> Price of fuel oil (cents/gallon):
        <input  type="text" id="input_takeaction_purchase_high_efficiency_heating_fueloilprice" size="3" maxlength="3" />
      </li>
      <li> Consumption Intensity: <span id="result_takeaction_purchase_high_efficiency_heating_intensity">0 </span> physical units*1000 / (HDD*sqft/1000)</li>
      <li> Emissions per physical unit of fuel: <span id="result_takeaction_purchase_high_efficiency_heating_gCO2fueltype">0 </span> gCO2e</li>
      <li> Physical units: kWh of electricity; cubic feet of natural gas; gallons of fuel oil</li>
      <li> Annual energy consumption in physical units of selected fuel type: <span id="result_takeaction_purchase_high_efficiency_heating_pu">0 </span></li>
	  <li> The cost difference between a conventional furnace and an energy star furnace is
	  <input type="text" id="input_takeaction_purchase_high_efficiency_heating_cost_difference" size="5" maxlength="5" />
	  </li>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_energy_star_fridge" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_energy_star_fridge"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_energy_star_fridge"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<img src="images/pledges/icon13.png" alt="" align="right" vspace="5" hspace="10"/> The next time I purchase a new refrigerator, I pledge to make it an Energy Star qualified decision. 
...
<div class="funfact">"Eat up" less energy: A new refrigerator with an ENERGY STAR label beats current federal standards by at least 20%.</div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/appliances//false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
  ...
  <div>
    <ul>
      ...
      <li> Refrigerator freezer volume:
        <input type="text" id="input_takeaction_energy_star_fridge_freezer" size="5" maxlength="5" />
        cubic feet </li>
      <li> The total volume is: <span id="result_takeaction_energy_star_fridge_totvolume">0</span> cubic feet</li>
      <li> Efficiency of conventional model: <span id="result_takeaction_energy_star_fridge_fridgekwh">0</span> kWh per cubic feet</li>
      <li> Efficiency of Energy Star model: <span id="result_takeaction_energy_star_fridge_ESfridgekwh">0</span> kWh per cubic feet</li>
      <li> Electricity price: <span class="kwhprice">0</span> cents per kWh (your local energy price based on the location you selected in the Introduction tab)</li>
    </ul>
  </div>
</div>
              </div>
	...
	<div class="new takeaction_section_housing">
              ...
              <tr>
                ...
                <td><a class="trigger" style="display: block;" href="javascript:;">
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        <td class="pledgeText" style="width: 315px;">Replace Printers With Energy Star Printers</td>
                        <!--
                        <td style="width: 50px; text-align: left;"><img src="images/categories/transportation32.png" style="width: 23px; height: 23px;"/></td>
                        -->
                        
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_energy_star_printers" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_energy_star_printers"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_energy_star_printers"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/es_printer.png" alt="Energy Star Printer" align="right" vspace="5" hspace="10"/>
<p>I will replace 
  <input id="input_takeaction_energy_star_printers_amount" type="text" size="2" maxlength="2" />
  conventional printers with Energy Star printers. I will purchase them for $<input id="input_takeaction_energy_star_printers_cost" type="text" size="4" maxlength="4" /> each.
  </p>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/energy+efficiency/%255BEligible+Applicants%253D%253DBusiness%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
...
<div class="assumption_content">
  <ul>
    <li>Annual energy savings: <input id="input_takeaction_energy_star_printers_annual_savings" type="text" size="3" maxlength="3" /> kWh</li>
  </ul>
</div>
              </div>
	...
	<div class="new takeaction_section_housing">
              ...
              <tr>
                ...
                <td><a class="trigger" style="display: block;" href="javascript:;">
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        <td class="pledgeText" style="width: 315px;">Replace Copiers With Energy Star Copiers</td>
                        <!--
                        <td style="width: 50px; text-align: left;"><img src="images/categories/transportation32.png" style="width: 23px; height: 23px;"/></td>
                        -->
                        
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_energy_star_copiers" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_energy_star_copiers"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_energy_star_copiers"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/es_copier.png" alt="Energy Star Copier" align="right" vspace="5" hspace="10"/>
<p>I will replace 
  <input id="input_takeaction_energy_star_copiers_amount" type="text" size="2" maxlength="2" />
  conventional copiers with Energy Star copiers. I can purchase them for $<input id="input_takeaction_energy_star_copiers_cost" type="text" size="4" maxlength="4" /> each.
  </p>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/energy+efficiency/%255BEligible+Applicants%253D%253DBusiness%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
...
<div class="assumption_content">
  <ul>
    <li>Annual energy savings: <input id="input_takeaction_energy_star_copiers_annual_savings" type="text" size="3" maxlength="3" /> kWh</li>
  </ul>
</div>
              </div>
	...
	<div class="new takeaction_section_housing">
              ...
              <tr>
                ...
                <td><a class="trigger" style="display: block;" href="javascript:;">
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        <td class="pledgeText" style="width: 315px;">Replace Desktop Computers With Energy Star Models</td>
                        <!--
                        <td style="width: 50px; text-align: left;"><img src="images/categories/transportation32.png" style="width: 23px; height: 23px;"/></td>
                        -->
                        
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_energy_star_desktops" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_energy_star_desktops"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_energy_star_desktops"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/es_comp.png" alt="Energy Star Desktop" align="right" vspace="5" hspace="10"/>
<p>I will replace 
  <input id="input_takeaction_energy_star_desktops_amount" type="text" size="2" maxlength="2" />
  conventional desktops with Energy Star desktops. I will purchase them for $<input id="input_takeaction_energy_star_desktops_cost" type="text" size="4" maxlength="4" /> each.
  </p>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/energy+efficiency/%255BEligible+Applicants%253D%253DBusiness%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
...
<div class="assumption_content">
  <ul>
    <li>Annual energy savings: <input id="input_takeaction_energy_star_desktops_annual_savings" type="text" size="3" maxlength="3" /> kWh</li>
  </ul>
</div>
              </div>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_rechargeable_batteries" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_rechargeable_batteries"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_rechargeable_batteries"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LITE/rechargeable.png"  alt="Rechargeable Batteries" align="right" vspace="5" hspace="10"/>

  <p>My monthly battery use:
  	<div style="margin-top:10; margin-bottom:10;"> </div>
  	<input id="input_takeaction_rechargeable_batteries_amount_aaa" type="text" size="3" maxlength="3" />
  	AAA <br />
    <input id="input_takeaction_rechargeable_batteries_amount_aa" type="text" size="3" maxlength="3" />
    AA <br />
    ...
    D <br />
    <input id="input_takeaction_rechargeable_batteries_amount_9v" type="text" size="3" maxlength="3" />
    9V <br /> 
...
<div class="assumption_content"> 
	...
	Rechargeable batteries can be re-used <input id="input_takeaction_rechargeable_batteries_uses" type="text" size="3" maxlength="3" />
  	time and costs <input id="input_takeaction_rechargeable_batteries_cost_multiple" type="text" size="3" maxlength="3" /> times as much as disposable models. 	
    </p>
    <p>	
    Cost of disposable batteries:
  	<div style="margin-top:5; margin-bottom:5;"> </div>
  	<ul>
  	$<input id="input_takeaction_rechargeable_batteries_cost_aaa" type="text" size="3" maxlength="3" />
  	per AAA <br />
    $<input id="input_takeaction_rechargeable_batteries_cost_aa" type="text" size="3" maxlength="3" />
    per AA <br />
 	$<input id="input_takeaction_rechargeable_batteries_cost_c" type="text" size="3" maxlength="3" />
    per C <br />
    $<input id="input_takeaction_rechargeable_batteries_cost_d" type="text" size="3" maxlength="3" />
    per D <br />
    $<input id="input_takeaction_rechargeable_batteries_cost_9v" type="text" size="3" maxlength="3" />
    per 9V 
    </ul>
   </p>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_power_mgmt_comp" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_power_mgmt_comp"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_power_mgmt_comp"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/es_pwrmgmt.png" alt="Power Management of Computers" align="right" vspace="5" hspace="10"/>
<p>I have <input id="input_takeaction_power_mgmt_comp_desktops" type="text" size="2" maxlength="2" /> desktops and <input id="input_takeaction_power_mgmt_comp_monitors" type="text" size="2" maxlength="2" /> monitors. <br/>
	I will put
	...
	<div class="new takeaction_section_housing">
        <h>
          <table style="margin-top: 5px;" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <td><a class="chkPledge" id="chkPledge_purchase_green_electricity" style="display: block;" href="javascript:takeaction_pledge('purchase_green_electricity');">
                <table align="center" class="trg" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        <td class="chkPledge" style="height: 30px;"> Pledge </td>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_purchase_green_electricity" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_purchase_green_electricity"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_purchase_green_electricity"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<img src="images/pledges/icon17.png" alt="Icon for clean energy" align="right" vspace="5" hspace="10" /> My household uses <span id="display_takeaction_purchase_green_electricity_kwhyear">0 </span> kilowatt hours of electricity per year, which produces <span id="result_takeaction_purchase_green_electricity_kwhCO2yr">0 </span> metric tons of CO2e per year. 
	I will purchase
...
<input type="text" id="input_takeaction_purchase_green_electricity_costclean" size="3" maxlength="3" />
per metric ton of CO2e.
<div class="funfact">Voluntary buy-in to EPA-certified green power has soared with 41% annual growth rates since 2004, and one in four utilites now offering the green power upgrade option. If you haven't joined yet, it's a simple and effective way to green your home's power.</div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search/home+electricity//false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
  ...
  <div>
    <ul>
      <li>cost of electricity
        <input type="text" id="input_takeaction_purchase_green_electricity_kwhcost" size="2" maxlength="2" />
        cents per kWh </li>
      <li>Green Power Facts Source: National Renewable Energy Laboratory Report - Voluntary Green Power Market 
        Forecast through 2015. May 2010 <a href="http://www.nrel.gov/docs/fy10osti/48158.pdf">nrel.gov PDF</a>
    </ul>
  </div>
</div>
<script>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_install_PV_panels" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_install_PV_panels"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_install_PV_panels"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/PVpanel.png" alt="Solar PV Panels" align="right" vspace="5" hspace="10"/>
My household uses <span id="display_takeaction_install_PV_panels_kwhyear">0 </span> kilowatt hours of electricity per year, which produces <span id="result_takeaction_install_PV_panels_kwhCO2yr">0 </span> metric tons of CO2e per year. 
<p>I will meet 
  ...
  of my electricity needs by installing solar photovoltaic (PV) panels. It costs $<input id="input_takeaction_install_PV_panels_w_cost" type="text" size="2" maxlength="2"/> per watt.</p>
...
<div class="assumption_content">
<li>Price of electricity: <span class="kwhprice">0</span> (cents/kWh) <img src="images/carb_question_mark.png" border="0" title="Click the Assumptions button above to change the price of electricity." class="tTip tTipHandle" /> </li>
<li>We assume 1654 kWh per Watt annual generation capacity (average for California). Actual generation capacity will vary by location, panel orientation, tree shading and other factors</li>
</div>              </div>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_install_solar_heating" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_install_solar_heating"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_install_solar_heating"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/solar_hotwater_h.png" alt="Solar Hot Water Heater" align="right" vspace="5" hspace="10"/>
A typical <span id="display_takeaction_install_solar_heating_sqft">0</span> square foot home in my climate uses
<input id="input_takeaction_install_solar_heating_ng_consumption" type="text" size="3" maxlength="3" /> cubic feet 
per year on heating.
<p>I will meet 
  ...
  of my heating needs by installing solar photovoltaic (PV) panels. It costs $<input id="input_takeaction_install_solar_heating_cost" type="text" size="2" maxlength="2"/> per cubic feet of natural gas. </p>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_low_flow_showerheads" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_low_flow_showerheads"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_low_flow_showerheads"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/lf_showerheads.png" alt="Low Flow Showerheads" align="right" vspace="5" hspace="10"/>
<p>
On average, we collectively take <input id="input_takeaction_low_flow_showerheads_avg_showers" type="text" size="3" maxlength"3" /> showers a day. <br/>
Our showers are on average taken for <input id="input_takeaction_low_flow_showerheads_length" type="text" size="3" maxlength="3" /> minutes each. <br/>
Of my household's <input id="input_takeaction_low_flow_showerheads_amount" type="text" size="3" maxlength="3" /> showerheads, I will replace 
<input id="input_takeaction_low_flow_showerheads_amount_replaced" type="text" size="3" maxlength="3" /> of them with more efficient, low-flow showerheads. 
They will each cost $<input id="input_takeaction_low_flow_showerheads_cost" type="text" size="4" maxlength="4" />.
</p>
...
<div class="assumption_content">
  <ul>
    <li>The cost to heat a gallon of water using natural gas is $<input id="input_takeaction_low_flow_showerheads_nat_gas_gallon" type="text" size="4" maxlength="4" /></li>
    <li>We assume that the conventional showerheads use <input id="input_takeaction_low_flow_showerheads_old_flow" type="text" size="4" maxlength="4" /> gallons per minute while the new low-flow showerheads use 
    <input id="input_takeaction_low_flow_showerheads_new_flow" type="text" size="4" maxlength="4" /> gallons per minute</li>
  </ul>
</div>
              </div>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_low_flow_faucets" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_low_flow_faucets"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_low_flow_faucets"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/lf_faucet.png" alt="Low Flow Faucet" align="right" vspace="5" hspace="10"/>
<p>
On average, we collectively use our faucets <input id="input_takeaction_low_flow_faucets_avg_daily_use" type="text" size="3" maxlength"3" /> times a day. <br/>
Of my household's <input id="input_takeaction_low_flow_faucets_amount" type="text" size="3" maxlength="3" /> faucets, I will replace 
...
They will each cost $<input id="input_takeaction_low_flow_faucets_cost" type="text" size="4" maxlength="4" />.
</p>
...
<div class="assumption_content">
  <ul>
    <li>On average, we assume that a faucet is used for  <input id="input_takeaction_low_flow_faucets_minutes" type="text" size="4" maxlength="4" /> per use. </li>
    <li>We assume that the conventional faucets use <input id="input_takeaction_low_flow_faucets_conventional" type="text" size="4" maxlength="4" /> gallons per minute while the new low-flow showerheads use 
    <input id="input_takeaction_low_flow_faucets_efficient" type="text" size="4" maxlength="4" /> gallons per minute</li>
  </ul>
</div>
              </div>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_low_flow_toilet" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_low_flow_toilet"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_low_flow_toilet"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LITE/lf_toilet.png" alt="Low Flow Toilet" align="right" vspace="5" hspace="10"/>
<p> I will replace 
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_line_dry_clothing" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_line_dry_clothing"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_line_dry_clothing"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<img src="images/pledges/icon16.png" alt="clothes_pins" align="right" vspace="5" hspace="10"/> My household dries
<input type="text" id="input_takeaction_line_dry_clothing_dryerldwk" size="3" maxlength="3" />
loads of laundry per week using <span id="result_takeaction_line_dry_clothing_dryerkwhyr">0</span> kWh of electricity per year, at a cost of $<span id="result_takeaction_line_dry_clothing_dryercostyr">0</span> per year.  
	I pledge to dry
...
<div class="funfact"> If it's not sunny enough outdoors, consider drying indoors. On top of saving emissions and money, it's nicer for your clothes and helps extend their lifetime.</div>
<div>
<a target="_blank" style="text-decoration: none; color:blue;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='blue'" href="http://www.coolcalifornia.org/funding-wizard#search//%255BZipcode%253D%253D94720%255D%255BEligible+Applicants%253D%253DIndividual%255D%255BCategory%253D%253DEnergy%255D/false/none/false/1/12">Find rebates and incentives for this action</a>
<img src="images/funding-wizard-icon.png" style="position: absolute; width:35px; padding-left: 5px;">
</div>  
...
<div class="assumption_content">
  <div id="input_takeaction_line_dry_clothing_housing14_2">
    <ul>
      <li>Electricity cost <span class="kwhprice">0</span> cents per kWh (based on energy prices for the location you selected in the Introduction tab)</li>
      <li> kWh per load: 3.16 <img src="images/carb_question_mark.png" border="0" title="The typical U.S. household uses 1150 kWh per year for clothes drying (RECS, 2001) at an average of 7.5 loads of clothes washed per day (Energy Saver Savings Calculator). We assume 7/7.5 loads washed are dried, for an average of 3.16 kWh per load." class="tTip tTipHandle" /></li>
    </ul>
  </div>
</div>
              </div>
	...
	<div class="new takeaction_section_housing">
        <h>
          <table style="margin-top: 5px;" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <td><a class="chkPledge" id="chkPledge_water_efficient_landscaping" style="display: block;" href="javascript:takeaction_pledge('water_efficient_landscaping');">
                <table align="center" class="trg" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        <td class="chkPledge" style="height: 30px;"> Pledge </td>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_water_efficient_landscaping" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_water_efficient_landscaping"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_water_efficient_landscaping"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LGDST/landscaping.png" alt="Water-Efficient Landscaping" align="right" vspace="5" hspace="10"/>
<p>A household of <span id="display_takeaction_water_efficient_landscaping_sqft">0</span> square feet typically has <input id="input_takeaction_water_efficient_landscaping_sqft" type="text" size="6" maxlength="6" /> square feet of landscaped area. Water efficient 
	landscapes can be obtained by introducing more drought-tolerant plants to your landscape and maintaining them more efficiently with drip-irrigation. <br />
<br />	
...
We assume that the incremental cost of drip irrigation is $<input id="input_takeaction_water_efficient_landscaping_cost_drip" type="text" size="4" maxlength="4" /> per square foot and the incremental cost of drought-tolerant plants is $
<input id="input_takeaction_water_efficient_landscaping_cost_drought" type="text" size="4" maxlength="4" />  per square foot
</p>
</div>              </div>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_plant_trees" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_plant_trees"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_plant_trees"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<p>In addition to the direct energy saving benefits, planting trees can increase natural beauty of city landscapes, reduce pollution, cool outside temperatures, as well as provide wood, fruit and other beneficial products. <br/>
	I will plant <input id="input_takeaction_plant_trees_amount" type="text" size="3" maxlength="3" /> trees. Each tree will cost $<input id="input_takeaction_plant_trees_cost" type="text" size="4" maxlength="4" />
  </p>
...
<div class="assumption_content">
  <ul>
  	...
  	<li>A large portion of your savings come from reduced AC use as a result of increased shading and a reduction in outside temperature. Trees also reduce heating by lowering wind speed</li>
  </ul>
</div>              </div>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_reduce_comm_waste" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_reduce_comm_waste"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_reduce_comm_waste"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LITE/reducewaste.png" alt="Reduce Commercial Waste" align="right" vspace="5" hspace="10"/>
...
<div class="assumption_content">
  <ul>
  	<li>225 pounds of waste per cubic yard: Source: <a href="http://epa.gov/epawaste/conserve/tools/warm/SWMGHGreport.html">EPA Warm Model</a></li>
  	<li>0.58 tCO2 (from methane) per short ton of waste: Source: <a href="http://epa.gov/epawaste/conserve/tools/warm/SWMGHGreport.html">EPA Warm Model</a></li>
  </ul>
</div>              </div>
	...
	<div class="new takeaction_section_housing">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_print_double_sided" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_print_double_sided"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_print_double_sided"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/LITE/print2side.png" alt="Print Double Sided" align="right" vspace="5" hspace="10"/>
<p>I will print  
	...
	<div class="new takeaction_section_offset">
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_offset_housing" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_offset_housing"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_offset_housing"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
        ...
        <div style="position: relative" class="inner">
          <div style="position: relative; ">
              ...
              <div class="pledge_container" style="font-size:12px; padding: 10px; position: relative; z-index: 10;">
              <img src="images/pledges/icon18.png" alt="" align="right" vspace="5" hspace="10"/> I have already pledged to reduce my housing footprint by <span id="result_takeaction_offset_housing_transpledges">0</span> metric tons of CO2e per year. I will purchase carbon offsets for the remaining <span id="result_takeaction_offset_housing_transtonsleft"> 0 </span> tons of CO2e at a cost of
<input name="offset" type="text" id="input_takeaction_offset_housing_offset" size="2" maxlength="2" />
dollars per metric ton.
<div class="funfact"> Avoiding GHG emissions in one place can "offset" GHG emissions occurring somewhere else. Offsets can go toward projects such as financing a wind turbine in Asia, a solar roof-top in Africa or a reforestation program in South America. Plus, carbon offset projects can produce positive quality-of-life impacts such as increasing economic and social development and supporting clean technology. </div>
<div class="assumption_button">
  <a href="javascript:;" class="assumptionShowHideLink">[<span class="takeaction_assumption_plusminus">+</span>] assumptions</a>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_low_carbon_diet" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_low_carbon_diet"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_low_carbon_diet"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<img src="images/pledges/icon20.png"  alt="veggies" align="right" vspace="5" hspace="10"/>
  ...
  <p>Use the selectors below to choose your new diet. How much of the following will each person eat daily (claories per day)? <img src="images/carb_question_mark.png" border="0" title="The default settings are for a low-carbon version of the typical American diet." class="tTip tTipHandle" />
  ...
  <div align="left"><strong>Total: </strong><span id="result_takeaction_low_carbon_diet_totalcal"> 0 </span> calories/day  </div>
<div class="funfact">A third of all food emissions in the United States come from red meat and dairy products, while chicken and vegetables have up to ten times smaller footprints per serving, so small diet switches can make a BIG difference. </div>
<div class="assumption_button">
  <a href="javascript:;" class="assumptionShowHideLink">[<span class="takeaction_assumption_plusminus">+</span>] assumptions</a>
</div>
<div class="assumption_content">
  <div>
    <ul>
      <li> Food prices are based on average U.S. prices for each category of food items (meat, dairy, fruits & vegetables, cereals and other). The actual carbon footprint and price of food you purchase may vary substantially from these values </li>
    </ul>
  </div>
</div>
              </div>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_go_organic" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_go_organic"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_go_organic"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<div class="funfact"> Organic products are available in nearly 20,000 natural foods stores, and are sold in nearly three-quarters of all conventional grocery stores</div>
                  ...
                  <table class="trg" border="0" cellpadding="0" cellspacing="0" style="height: 30px;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 105px; text-align: center;"><span class="takeaction_pounds" id="takeaction_pounds_offset_shopping" style="color: #415683"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_dollars" id="takeaction_dollars_offset_shopping"></span></td>
                        <td style="width: 105px; text-align: center;">$<span class="takeaction_net10yr" id="takeaction_net10yr_offset_shopping"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  </a></td>
...
<img src="images/pledges/icon22.png" alt="" align="right" vspace="5" hspace="10"/> I have already pledged to reduce my food, goods and services footprint by <span id="result_takeaction_offset_shopping_transpledges">0</span> metric tons of CO2e per year. I will purchase carbon offsets for the remaining <span id="result_takeaction_offset_shopping_transtonsleft"> 0 </span> tons of CO2e at a cost of
...
<ul>
	  <li>
	    ...
	    <input type='text' id="input_takeaction_assumption_price_of_gasoline" size="4" maxlength="4" /> <span class="style17">&nbsp; per gallon</span>
	  </li>
	  <li>
	  ...
	  <li>
	    ...
	    <img src="images/carb_question_mark.png" border="0" class="tTip tTipHandle"
        title="<strong>Average residential price of natural gas ($/therm):</strong><br />US=1.38; 
	  ...
	  <li>
	    <span>Inflation rate:&nbsp; </span><input type='text' id="input_takeaction_assumption_inflationrate" size="2" maxlength="2" />
	    <span>% (used in NPV and ROI calculations)</span>
	  </li>
	</ul>
</div>
...
<div id="tooltip1b" style="opacity:0;  position: absolute; z-index: 3000; width: 150px; height: 88px; left: 0; bottom: 0; background-image:url('./images/hover_balloon.png'); background-repeat: no-repeat; " onMouseOver="if (!animating) {$('#tooltip1b').hide();}" onMouseMove="if (!animating) {$('#tooltip1b').hide();}">
...
<div style="font-family: Verdana, Geneva, sans-serif; font-size: 11px; margin-left: 10px"> <a id="link_reset_axis" href="javascript:;" title="Click here to reset the height of the graph" class="tTip tTipHandle" style="color: #666; text-decoration: none;"> Reset Axis </a> </div>
...
<div id="green_design" style=" display:none; padding: 8px 0; overflow: auto;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 10px"> <a href="http://gdi.ce.cmu.edu/" target="_blank" style="border: none;"> <img src="images/gdi_logo.jpg" style="border: none; float: right;" /> </a> Greenhouse gas emission factors provided in part by license agreement with the <a href="http://gdi.ce.cmu.edu/" target="_blank">Green Design Institute</a> at Carnegie Mellon University. </div>

<div class="footerLinks" style="margin-top: 25px; z-index: 5000; text-align:center; width: 100%;"><a href="http://coolclimate.berkeley.edu/terms-of-use" target="_blank">terms of use</a> | <a href="http://www.coolcalifornia.org/calculator-documentation" target="_blank">documentation</a> | <a href="http://coolcalifornia.org/article/faq-for-calculator" target="_blank">F.A.Q.</a> | <a href="http://www.surveymonkey.com/s.aspx?sm=EvM_2bdWqoS1MMrt08SnoD1A_3d_3d" target="_blank">take our survey</a></div>
